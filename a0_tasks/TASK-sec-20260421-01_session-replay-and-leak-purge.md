...
| `test_precommit_blocks_forced_add.sh` | `9_others/src/deploy/test/` (chmod +x) |
| `test_precommit_blocks_plaintext_secret.sh` | `9_others/src/deploy/test/` (chmod +x) |
...
#### B.2.3 — `9_others/src/deploy/git-hooks/pre-commit`
...
**`9_others/src/deploy/scripts/cloud-ship-container-engine.sh`** — insert before `SSH_OPTS=` line:
```bash
