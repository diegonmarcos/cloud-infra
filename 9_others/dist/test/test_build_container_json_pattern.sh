...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_build_container_json_pattern.sh
...
# ║   ../../../1_cloud-configs/dist/build-<container>.json (real file)       ║
# ║   OR  ../build-<container>.json (service-local real file)        ║
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_build_container_json_pattern.sh
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
