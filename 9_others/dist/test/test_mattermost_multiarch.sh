...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_mattermost_multiarch.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_mattermost_multiarch.sh    ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
# -L follows symlinks (build-*.json files are symlinks to ../../../1_cicd/dist/)
