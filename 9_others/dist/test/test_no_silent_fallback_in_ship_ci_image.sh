...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_no_silent_fallback_in_ship_ci_image.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_no_silent_fallback_in_ship_ci_image.sh
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
for src in \
    "$REPO_ROOT/1_cicd/src/cicd/ship-ci-image.yml" \
    "$REPO_ROOT/1_cicd/src/cicd/ship.yml"; do
    [ -f "$src" ] || continue
    rel="${src#$REPO_ROOT/}"
