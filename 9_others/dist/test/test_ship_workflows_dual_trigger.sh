...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_ship_workflows_dual_trigger.sh
...
#
# This test catches it at compile time — `bash 9_others/build.sh build` will
# call this in dist/ regen testing if invoked, OR run directly:
#   bash 9_others/test/test_ship_workflows_dual_trigger.sh
set -eu
