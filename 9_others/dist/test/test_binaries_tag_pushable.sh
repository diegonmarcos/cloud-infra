...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_binaries_tag_pushable.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_binaries_tag_pushable.sh   ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
DOCKER_STEP="$REPO_ROOT/1_cicd/src/scripts/cloud-ship-container-step-build-docker.sh"
