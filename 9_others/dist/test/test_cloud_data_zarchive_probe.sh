...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_cloud_data_zarchive_probe.sh
...
# ║                                                                  ║
# ║ Audit follow-up (2026-05-05): the derive script (9_others/      ║
...
# ║ 9_others/build.json + dist/build-workflows.json (2026-05-09)  ║
# ║ and is no longer relevant to this fallback probe.                ║
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_cloud_data_zarchive_probe.sh
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
# was migrated to 9_others/build.json + dist/build-workflows.json on
