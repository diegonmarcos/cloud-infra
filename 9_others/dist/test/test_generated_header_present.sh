...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_generated_header_present.sh
...
# ║   1_cicd/src/scripts/cloud-ship-repo-workflow-engine.sh     ║
# ║   carries the "GENERATED FILE — DO NOT EDIT" banner defined in   ║
# ║   9_others/src/generated-header.json.                    ║
# ║                                                                  ║
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_generated_header_present.sh║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
