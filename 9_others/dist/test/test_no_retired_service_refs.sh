...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_no_retired_service_refs.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_no_retired_service_refs.sh ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
echo ""
echo "── 1_cicd/dist topology files must not list retired services as .name ──"
...
for svc in $retired; do
    hits=""
    for topo in "$REPO_ROOT"/1_cicd/dist/cloud-data-containers-*.json; do
        [ -f "$topo" ] || continue
