...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_arch_runner_routing.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_arch_runner_routing.sh     ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
if [ -z "$RUNNERS_JSON" ]; then
    fail "build-workflows.json not found under 1_cicd/dist/ or repo root"
else
