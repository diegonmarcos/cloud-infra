...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_ship_cargo_cache.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_ship_cargo_cache.sh        ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
SHIP_YML="$REPO_ROOT/1_cicd/src/cicd/ship.yml"
DOCKER_BUILD_SH="$REPO_ROOT/1_cicd/src/scripts/cloud-ship-container-step-build-docker.sh"
