...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_no_hardcoded_builder_image_literals.sh
...
# ║                                                                  ║
# ║ Usage:                                                           ║
# ║   bash 9_others/test/test_no_hardcoded_builder_image_literals.sh
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
SCAN_ROOTS=(
  ...
  "$REPO_ROOT/1_cicd/src/cicd"
  "$REPO_ROOT/1_cicd/src/actions"
  "$REPO_ROOT/1_cicd/src/scripts"
  "$REPO_ROOT/1_cicd/dist/cicd"
  "$REPO_ROOT/1_cicd/dist/actions"
  "$REPO_ROOT/1_cicd/dist/scripts"
)
# unix-side wrappers — only the CANONICAL source path (1_cicd/src/cicd).
...
if [ -d "$REPO_ROOT/II_Unix/1_cicd/src/cicd" ]; then
  SCAN_ROOTS+=("$REPO_ROOT/II_Unix/1_cicd/src/cicd")
fi
