...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_step_docker_root_docker_repair.sh
...
#
# Run:  bash 9_others/test/test_step_docker_root_docker_repair.sh
set -eu
...
ENGINE="$REPO_ROOT/1_cicd/src/scripts/cloud-ship-container-step-build-docker.sh"
