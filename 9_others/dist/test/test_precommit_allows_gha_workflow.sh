...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_precommit_allows_gha_workflow.sh
...
# ║   engine paths (.github/workflows/, 1_cicd/src/cicd/,       ║
# ║   1_cicd/dist/) whose filename mentions secrets BUT whose   ║
# ║   content is a proper GHA workflow (has `on:` and `jobs:`).      ║
# ║                                                                  ║
# ║   Non-workflow files with secret-ish names must still be blocked.║
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_precommit_allows_gha_...   ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
HOOK="$REPO_ROOT/0_git/dist/hooks/pre-commit"
