...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_no_legacy_unix_static_workflows.sh
...
# ║ trees in parallel:                                               ║
# ║   • unix/1_cicd/src/cicd/   (active, builds via build.sh)   ║
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_no_legacy_unix_static_workflows.sh
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
for f in 1_cicd/src/cicd/ship-builders.yml 1_cicd/src/cicd/ship-containers.yml; do
    if [ -e "$unix_root/$f" ]; then
