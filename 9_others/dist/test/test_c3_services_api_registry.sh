...
# ║                                                                  ║
# ║   Source : 9_others/src/../test/test_c3_services_api_registry.sh
...
# ║                                                                  ║
# ║ Usage: bash 9_others/test/test_c3_services_api_registry.sh ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
[ -f "$BUILD_FILE" ] || { echo "FATAL: missing $BUILD_FILE — run 9_others/build.sh all" >&2; exit 1; }
