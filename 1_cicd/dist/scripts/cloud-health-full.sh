...
# ║                                                                  ║
# ║   Source : 1_cicd/src/ops/cloud-health-full.sh
...
for _p in \
    ...
    "${CLOUD_ROOT:-$REPO_ROOT}/1_cicd/dist/cloud-data-topology.json" \
    "${CLOUD_ROOT:-$REPO_ROOT}/1_cicd/dist/z_archive/cloud-data-topology.json" \
