...
_load_cf_credentials() {
    ...
    for cf_env in \
        "$HOME/git/cloud-vault/A_A0-Providers/B_SERVICES-CLOUD/b4-cloudflare/api-key_opaque/cloudflare.env" \
        "/home/diego/git/cloud-vault/A_A0-Providers/B_SERVICES-CLOUD/b4-cloudflare/api-key_opaque/cloudflare.env"; do
        if [ -f "$cf_env" ]; then
