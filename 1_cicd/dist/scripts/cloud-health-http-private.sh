...
# ║                                                                  ║
# ║   Source : 1_cicd/src/ops/cloud-health-http-private.sh
...
if [ -n "$CONS" ]; then
    ...
    for _p in \
        ...
        "${CLOUD_ROOT:-$REPO_ROOT}/1_cicd/dist/cloud-data-dns-services.json" \
        "${CLOUD_ROOT:-$REPO_ROOT}/1_cicd/dist/z_archive/cloud-data-dns-services.json" \
