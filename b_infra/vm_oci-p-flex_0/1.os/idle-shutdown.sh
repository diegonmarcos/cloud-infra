...
# Always-on containers: none initially
#
# Idle conditions (ALL must be true):
#   - No active SSH sessions
#   - CPU load < 60% (3 cores, background containers ~5-10% baseline)
...
perform_shutdown() {
    ...
    # curl -X POST "https://n8n.diegonmarcos.com/webhook/vm-shutdown" -d '{"vm":"oci-p-flex_0"}' || true
