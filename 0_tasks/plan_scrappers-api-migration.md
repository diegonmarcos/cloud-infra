...
- `2_configs` derived data (caddy route, dns, topology) + backup DAG.
...
- **Data-driven targets** — `scrappers.json` (service `src/` or `2_configs/inputs/`) lists
...
**Phase 6 — Cleanup.** Delete crawlee GHCR images, docs, `2_configs` references; regenerate derived
