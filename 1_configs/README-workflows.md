# 1_configs — Cloud CI/CD & Build System

Single source of truth for **all** executable logic, GHA workflows, git hooks, and repo configuration.
...
All scripts live in `src/scripts/` and follow the naming convention:
...
| `ship-ci-image.yml` | Push to `1_configs/src/cloud-builder/` | Rebuild cloud-builder Docker image |
