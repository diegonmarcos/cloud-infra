...
# ║                                                                  ║
# ║   Source : 1_configs/src/scripts/cloud-ship-container-engine.sh
...
# Steps are in the same directory as this engine (1_configs/src/scripts/)
...
# Template + prefix map live in 1_configs/src/libs/generated-header.json.
INJECT_HEADER="$STEPS_DIR/../libs/inject-header.sh"
ENGINE_NAME="1_configs/src/scripts/cloud-ship-container-engine.sh"
