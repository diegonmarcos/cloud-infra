...
# ║                                                                  ║
# ║   Source : 1_configs/src/scripts/cloud-health-full.sh
...
for _p in \
    ...
    "${CLOUD_ROOT:-$REPO_ROOT}/1_configs/dist/cloud-data-topology.json" \
    "${CLOUD_ROOT:-$REPO_ROOT}/1_configs/dist/z_archive/cloud-data-topology.json" \
