...
# ║                                                                  ║
# ║   Source : 1_configs/src/deploy/scripts/cloud-ship-container-step-build-docker.sh
...
NEOF
    ...
    # Source-of-truth: 1_configs/build.json (.runners + .probe + .dispatch),
    # aggregated by 1_configs/build.sh into dist/build-workflows.json.
    ...
    for _p in \
        ...
        "${CLOUD_ROOT:-$SERVICE_DIR/../..}/1_configs/src/build-workflows.json" \
