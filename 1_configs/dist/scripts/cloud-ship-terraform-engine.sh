...
# ║                                                                  ║
# ║   Source : 1_configs/src/scripts/cloud-ship-terraform-engine.sh
...
STEPS_DIR="$(cd "$(dirname "$0")/../../1_configs/src/scripts" 2>/dev/null && pwd)"
...
ENGINE_NAME="1_configs/src/scripts/cloud-ship-terraform-engine.sh"
