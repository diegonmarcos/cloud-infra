...
# ║                                                                  ║
# ║   Source : 1_configs/src/deploy/scripts/test_ensure_image_public_and_pull_gate.sh
...
DOCKER_STEP="$HERE/cloud-ship-container-step-build-docker.sh"
DEPLOY_STEP="$HERE/cloud-ship-container-step-deploy-compose.sh"
