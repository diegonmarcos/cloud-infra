...
# ║                                                                  ║
# ║   Source : 1_configs/src/test/test_step_docker_guards.sh
...
# ║                                                                  ║
# ║ Usage: bash 1_configs/src/test/test_step_docker_guards.sh      ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
DOCKER_STEP="$REPO_ROOT/1_configs/src/gha/scripts/cloud-ship-container-step-build-docker.sh"
