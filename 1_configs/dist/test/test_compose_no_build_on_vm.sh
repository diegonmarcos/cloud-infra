...
# ║                                                                  ║
# ║   Source : 1_configs/src/test/test_compose_no_build_on_vm.sh
...
# ║                                                                  ║
# ║ Usage:                                                           ║
# ║   bash 1_configs/src/test/test_compose_no_build_on_vm.sh       ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
ENGINE="$REPO_ROOT/1_configs/src/gha/scripts/cloud-ship-container-step-deploy-compose.sh"
