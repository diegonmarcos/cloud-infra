...
//   - 1_configs/dist/_cloud-data-consolidated.json  ← VMs (ip, wg_ip, wg_role,
...
//
// Output:
//   - 1_configs/dist/mesh-snapshot.json   (schema: wg-mesh/v1)
//
...
function build(): Snapshot {
  const consolidatedRel = '1_configs/dist/_cloud-data-consolidated.json';
  ...
  return {
    _meta: {
      generated_at: now,
      generated_by: '1_configs/src/engines/derive-mesh-snapshot.ts',
      schema:       'wg-mesh/v1',
      sources: {
