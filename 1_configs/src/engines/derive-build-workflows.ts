...
//
//   • 1_configs/src/scripts/cloud-ship-ci-builder-dispatch.sh
//   • 1_configs/src/scripts/cloud-ship-container-step-build-docker.sh
//   • 1_configs/src/libs/cloud-paths.sh
...
function main(): void {
  ...
  const out = {
    _comment:
      "Derived by 1_configs/src/engines/derive-build-workflows.ts from 1_configs/build.json (name/probe/dispatch) and 1_configs/cloud-builders-runner.json (runners, when present — falls back to build.json's .runners otherwise). Do not edit — edit the source.",
