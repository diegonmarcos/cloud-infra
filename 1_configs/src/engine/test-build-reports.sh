...
#
# Asserted invariants:
#   1. cloud/1_configs/dist/build-reports.json exists.
...
#      cloud/1_configs/dist/build-reports.json — consumers reading the
...
DIST="$REPO/1_configs/dist/build-reports.json"
