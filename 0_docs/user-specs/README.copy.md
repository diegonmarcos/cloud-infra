...
| `cloud-data-configs.json` | Caddy routes, Authelia clients, DNS zones |
| `cloud-data-deps.json` | npm dependencies per service |
| `cloud-data-caddy-routes.json` | Caddy reverse proxy route definitions |
...
Engine source: `a_solutions/bc-obs_c3-infra-api/src/shared/engines/`
...
| `cloud-cgc-mcp` | HTTP (remote) + stdio (local) | 50+ | Knowledge graph, specs, docs, skills, Octocode semantic search |
