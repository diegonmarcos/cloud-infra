...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_generated_header_present.sh
...
# ║   1_workflows/src/scripts/cloud-ship-repo-workflow-engine.sh     ║
...
# ║                                                                  ║
# ║ Usage: bash 1_workflows/src/test/test_generated_header_present.sh║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../.." && pwd)"
DIST="$REPO_ROOT/1_workflows/dist"
