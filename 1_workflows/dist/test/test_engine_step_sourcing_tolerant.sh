...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_engine_step_sourcing_tolerant.sh
...
ENGINE="$REPO_ROOT/1_workflows/src/scripts/cloud-ship-container-engine.sh"
...
for step_file in "$REPO_ROOT/1_workflows/src/scripts/cloud-ship-container-step-"*.sh; do
