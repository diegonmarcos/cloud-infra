...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_no_retired_service_refs.sh
...
# ║                                                                  ║
# ║ Usage: bash 1_workflows/src/test/test_no_retired_service_refs.sh ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
echo ""
echo "── 2_configs/dist topology files must not list retired services as .name ──"
...
for svc in $retired; do
    hits=""
    for topo in "$REPO_ROOT"/2_configs/dist/cloud-data-containers-*.json; do
        [ -f "$topo" ] || continue
