...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_step_docker_root_docker_repair.sh
...
#
# Run:  bash 1_workflows/src/test/test_step_docker_root_docker_repair.sh
set -eu

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../../.." && pwd)"
ENGINE="$REPO_ROOT/1_workflows/src/scripts/cloud-ship-container-step-build-docker.sh"
