...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_ship_workflows_dual_trigger.sh
...
#
# This test catches it at compile time — `bash 1_workflows/build.sh build` will
# call this in dist/ regen testing if invoked, OR run directly:
#   bash 1_workflows/src/test/test_ship_workflows_dual_trigger.sh
set -eu
