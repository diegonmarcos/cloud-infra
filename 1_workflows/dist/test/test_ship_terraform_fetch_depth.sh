...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_ship_terraform_fetch_depth.sh
...
FILES=(
  "$REPO_ROOT/1_workflows/src/cicd/ship-terraform.yml"
  "$REPO_ROOT/1_workflows/dist/ship-terraform.yml"
