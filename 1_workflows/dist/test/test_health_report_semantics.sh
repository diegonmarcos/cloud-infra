...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_health_report_semantics.sh
...
# ║                                                                  ║
# ║ Usage: bash 1_workflows/src/test/test_health_report_semantics.sh ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
for p in \
    ...
    "$REPO_ROOT/2_configs/dist/reports/src/cloud-health-full-2/src" \
