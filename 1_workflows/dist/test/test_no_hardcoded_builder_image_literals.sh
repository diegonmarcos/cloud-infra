...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_no_hardcoded_builder_image_literals.sh
...
# ║                                                                  ║
# ║ Usage:                                                           ║
# ║   bash 1_workflows/src/test/test_no_hardcoded_builder_image_literals.sh
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail
...
SCAN_ROOTS=(
  ...
  "$REPO_ROOT/1_workflows/src/cicd"
  "$REPO_ROOT/1_workflows/src/actions"
  "$REPO_ROOT/1_workflows/src/scripts"
  "$REPO_ROOT/1_workflows/dist/cicd"
  "$REPO_ROOT/1_workflows/dist/actions"
  "$REPO_ROOT/1_workflows/dist/scripts"
)
# unix-side wrappers — only the CANONICAL source path (1_workflows/src/cicd).
...
if [ -d "$REPO_ROOT/III_unix/1_workflows/src/cicd" ]; then
  SCAN_ROOTS+=("$REPO_ROOT/III_unix/1_workflows/src/cicd")
fi
