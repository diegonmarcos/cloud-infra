...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_docker_npm_baked_into_image.sh
...
#
# Run:  bash 1_workflows/src/test/test_docker_npm_baked_into_image.sh
set -eu
...
ENGINE="$REPO_ROOT/1_workflows/src/scripts/cloud-ship-terraform-deploy-apply.sh"
