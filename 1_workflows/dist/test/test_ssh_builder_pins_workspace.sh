...
# ║                                                                  ║
# ║   Source : 1_workflows/src/test/test_ssh_builder_pins_workspace.sh
...
# ║                                                                   ║
# ║ Usage: bash 1_workflows/src/test/test_ssh_builder_pins_workspace.sh ║
# ╚══════════════════════════════════════════════════════════════════╝
set -eo pipefail

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../.." && pwd)"
SCRIPT="$REPO_ROOT/1_workflows/src/scripts/cloud-ship-container-step-build-docker.sh"
