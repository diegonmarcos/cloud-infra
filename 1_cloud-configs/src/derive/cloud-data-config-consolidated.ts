...
const CLOUD_DATA_DIR = join(CONFIGS_DIR, "dist");             // sole write target (cloud/1_cloud-configs/dist)
...
function main() {
  ...
  // a_solutions/<svc>/src/_cloud-data-consolidated.json → 1_cloud-configs/dist/, but
